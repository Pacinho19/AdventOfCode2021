...
public class Day13Part2 {
    ...
    public void calculate(String filePath) {
        ...
        foldInstructions.forEach(foldInstruction -> board = fold(foldInstruction));

        printBoard(); // answer is in result array ! :D
    }
